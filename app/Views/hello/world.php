...
<section>
    <div class="container">
        <hr>
        <h2 class="text-center">Frozen Food</h2>
        <hr>
                ...
                <div class="col-4">
                    <div class="card text-center mt-3">
                        ...
                        <div class="card-body" style="height: 375px;">
                            <img src="<?= base_url('uploads/' . $m->gambar); ?>" class="img-thumbnail" style="max-height: 200px;">
                            <h4 class="mt-3"><?= $m->nama; ?></h4>
                            <h5 class="mt-3 text-success"><?= "Rp " . number_format($m->harga, 2, ',', '.'); ?></h5>
                            <p class="text-info">Stok : <?= $m->stok; ?></p>
                        </div>
                        <div class="card-footer">
                            <a href="<?= site_url('etalase/beli/' . $m->id); ?>" style="width: 100px;" class="btn btn-success">Beli</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
